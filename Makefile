...
%.vs.asm: %.vs.cg $(VP20COMPILER)
	@echo "[ CG       ] $@"
	$(VE) $(CGC) -profile vp20 -o $@.tmp $< $(QUIET); \
	head -n 1 $@.tmp > $@; \
	echo "# This file was auto-generated by the nxdk build-system" >> $@; \
	echo "" >> $@; \
	tail -n +3 $@.tmp >> $@; \
	rm -f $@.tmp

%.vs.inl: %.vs.asm $(VP20COMPILER)
	@echo "[ VP20     ] $@"
	@echo "/* This file was auto-generated by the nxdk build-system */" > $@; \
	echo "" >> $@; \
	$(VP20COMPILER) $< >> $@
...
%.ps.asm: %.ps.cg
	@echo "[ CG       ] $@"
	$(VE) $(CGC) -profile fp20 -o $@.tmp $< $(QUIET); \
	echo "// This file was auto-generated by the nxdk build-system" > $@; \
	echo "" >> $@; \
	cat $@.tmp >> $@; \
	rm -f $@.tmp

%.ps.inl: %.ps.asm $(FP20COMPILER)
	@echo "[ FP20     ] $@"
	@echo "/* This file was auto-generated by the nxdk build-system */" > $@; \
	echo "" >> $@; \
	$(FP20COMPILER) $< >> $@
